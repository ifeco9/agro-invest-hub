...
const Shop = () => {
  ...
  const investmentOpportunities: InvestmentOpportunity[] = [
    {
      id: "three-month",
      title: "3-Month Partnership Plan",
      region: "Multi-State",
      ...
      slotsAvailable: 50,
      type: "Short Term",
      description: "Short-term engagement for quick returns. Capital returned at end of period.",
      price: 500000,
    },
    {
      id: "six-month",
      title: "6-Month Partnership Plan",
      region: "Multi-State",
      ...
      slotsAvailable: 40,
      type: "Medium Term",
      description: "Balanced duration with strong returns. Ideal for livestock and crop cycles.",
      price: 500000,
    },
    {
      id: "one-year",
      title: "1-Year Partnership Plan",
      region: "Multi-State",
      ...
      slotsAvailable: 30,
      type: "Long Term",
      description: "High-yield annual partnership for palm oil, cocoa, and export grains.",
      price: 1000000,
    },
    {
      id: "two-year",
      title: "2-Year Partnership Plan",
      region: "Nationwide",
      ...
      slotsAvailable: 20,
      type: "Premium",
      description: "Long-term growth with premium returns for large-scale livestock and plantations.",
      price: 1000000,
    },
    {
      id: "three-year",
      title: "3-Year Partnership Plan",
      region: "Nationwide",
      ...
      slotsAvailable: 10,
      type: "Premium",
      description: "Maximum returns for large-scale partners. Focus on processing and export.",
      price: 5000000,
    },
  ];
